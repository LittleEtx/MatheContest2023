...
class BasicMapTest {
    ...
    fun `slope with angle 0`() {
        ...
        assertEquals(0.0, map.heightAt(0.0, 0.0))
        assertEquals(0.0, map.heightAt(1.0, 0.0))
        assertEquals(0.0, map.heightAt(2.0, -1.0))
    }
    ...
    fun `slope with basic direction`() {
        ...
        assertEquals(0.0, map.heightAt(0.0, 0.0))
        assertEquals(-1.0, map.heightAt(1.0, 0.0))
        assertEquals(-2.0, map.heightAt(2.0, -1.0))
        assertEquals(2.0, map.heightAt(-2.0, 3.0))
    }
    ...
    fun `slope with direction of 30 degree`() {
        ...
        assertEquals(2.0, map.heightAt(0.0, 0.0))
        assertEquals(0.0, map.heightAt(4 * cos(dir), 4 * sin(dir)))
        assertEquals(0.0, map.heightAt(4 / cos(dir), 0.0))
    }
}
